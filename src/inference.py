...
def parse_arguments():
    ...
    parser.add_argument('-nhl', '--num_layers', '--num_hidden_layers', dest='num_layers', type=int, default=3, help= 'Number of hidden layers')
    # parser.add_argument('-sz', '--hidden_size', type=str, default="128,128,64", help='Comma-separated number of neurons (e.g., "128,64,32")')
    parser.add_argument('-sz', '--hidden_size', '--hidden_layer_sizes', dest= 'hidden_size',type=int, nargs='+', default=[128,128,64] , help= 'Number of neurons in each hidden layer (list of values)')
